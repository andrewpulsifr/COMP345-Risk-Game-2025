...
void testTournament(int argc, char* argv[]) {
    ...
    // // Testing that the command is processed and validated in validateTournament() of the CommandProcessor.
    // std::cout << "TEST 1: All parameters are valid (tournament -M World.map -P Juan Chhay Ben -G 3 -D  12)" << std::endl;
    // cmdPro.validateTournament("tournament -M World.map -P Juan Chhay Ben -G 3 -D  12"); // TESTING 1
    // std::cout << "========================================================================================" << std::endl;
    // std::cout << "TEST 2: Invalid parameter -P. (tournament -M World.map -P 10 -G  3 -D  12)" << std::endl;
    // cmdPro.validateTournament("tournament -M World.map -P 10 -G  3 -D  12"); // TESTING 2
    // std::cout << "========================================================================================" << std::endl;
